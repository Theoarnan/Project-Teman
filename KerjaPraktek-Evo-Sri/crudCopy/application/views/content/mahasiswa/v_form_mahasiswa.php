<div class="card">
	...
	<div class="card-body">
		<form id="form-tambah-mhs" enctype="multipart/form-data" method="post" action="<?= site_url("mahasiswa/proses_simpan") ?>">
			...
			<div class="form-group">
				<label for="">IPK</label>
				<input required type="number"  name="ipk" id="ipk" class="form-control" />
			</div>
