<div class="card">
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<a href="<?= site_url("mahasiswauser/update/$row->id_mahasiswa") ?>" class="btn btn-sm btn-warning">
	...
	<div class="card-footer">
		<a href="<?= site_url("mahasiswauser/tambah") ?>" class="btn btn-primary">
...
<form id="form-delete" method="post" action="<?= site_url('mahasiswauser/proses_hapus') ?>">
