<div class="content-wrapper">
	<section class="content">
		<!-- <form id="formDataCust" role="form"> -->
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="col-md-5">
							<div class="form-group">
								...
								<select name="" class="form-control" id="select-customer" required>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" id="no-order" name="no-order" class="form-control" required />
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="">NO PO</label>
									<input type="number" id="no-po" name="no-po" class="form-control" required />
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="">NO PR</label>
									<input type="number" id="no-pr" name="no-pr" class="form-control" required />
								</div>
							</div>
						</div>
						<div class="form-group">
							<label for="">Kode Customer</label>
							<input readonly type="text" id="kode-kustomer" name="kd_kustomer" class="form-control" required />
						</div>
						<div class="form-group">
						...
						<div class="col-md-2">
							...
							<div class="form-group">
								...
								<input type="date" id="tanggal-minta-dikirim" name="tgl_kirim" class="form-control" required />
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" id="jml-order" name="jml_order" class="form-control" required>
								</div>
							</div>
						</div>
						<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<input type="hidden" id="id-order" name="id-order" class="form-control" />
							<div class="col-md-6">
								<div class="form-group">
			...
			<div class="card-body">
				<a href="" id="btn-save-transaksi" class="btn btn-primary float-right"><i class="fas fa-save"></i>Tambah</a>
			</div>
		</div>
		<!-- </form> -->
	</section>
	...
	$(function() {
		...
		$("#btn-add-item").on("click", function() {
			...
			if (format != "") {
				...
				tr += `<td><input type="text" value="${format}" name="format" class="form-control"/></td>`;
				tr += `<td><input type="text" value="${jenisKertas}" name="jns_kertas" class="form-control"/></td>`;
				tr += `<td><input type="text" value="${warnaKertas}" name="warna_kertas" class="form-control"/></td>`;
				tr += `<td><input type="text" value="${warnaTinta}" name="warna_tinta" class="form-control"/></td>`;
				tr += `<td><input type="number" value="${jumlahOrder}" name="jumlah_order" class="form-control"/></td>`;
				tr += `<td>`;
		...
		$("#btn-save-transaksi").on("click", function(e) {
			...
			let dataKirim = JSON.stringify(data);
			console.log(dataKirim);
			$.ajax({
				url: "<?php echo base_url('appsuper/proses_simpan') ?>",
				type: "POST",
				data: {
