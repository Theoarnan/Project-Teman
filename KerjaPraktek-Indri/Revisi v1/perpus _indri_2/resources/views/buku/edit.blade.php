                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample">
                                ...
                                <div class="form-group{{ $errors->has('kategori_id') ? ' has-error' : '' }}">
                                    <label for="kategori_id" class="col-md-4 control-label">Kategori Buku</label>
                                    <div class="col-md-6">
                                        <select name="kategori_id" class="form-control" required>
                                            <option disabled>Pilih Kategori Buku</option>
                                            @foreach($kategori as $category)
                                             <option value="{{$category->id}}">{{$category->nama_kategori_buku}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <img width="200" height="200" @if($data->cover)
                                        src="{{ asset('images/buku/'.$data->cover) }}" @endif />
