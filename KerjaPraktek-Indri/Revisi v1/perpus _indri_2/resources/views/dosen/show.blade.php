                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample">
                            ...
                            <div class="form-group{{ $errors->has('nidn') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="nidn" type="number" class="form-control" name="nidn"
                                        value="{{ $data->nidn }}" maxlength="8" readonly>
                                    @if ($errors->has('nidn'))
                                    <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="ps" required="" disabled="">
                                        <option value=""></option>
                                        <option value="I">Informatika</option>
                                        <option value="T">Teknik Sipil</option>
                                        <option value="F">Fisika</option>
                                        <option value="M">Manajemen</option>
                                        <option value="A">Akuntansi</option>
                                        <option value="P">Pendidikan Agama Kristen</option>
                                        <option value="MG">Musik Gereja</option>
                                        <option value="TH">Theologia Konseling Kristen</option>
                                    </select>
                                </div>
                            </div>
