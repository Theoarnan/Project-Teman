      ...
      <div class="card-body">
        <div class="clearfix">
          ...
          <div class="float-right">
            ...
            <div class="fluid-container">
              <h3 class="font-weight-medium text-right mb-0">{{$mahasiswa->count()}}</h3>
            </div>
          </div>
        </div>
        <p class="text-muted mt-3 mb-0">
          <i class="mdi mdi-account mr-1" aria-hidden="true"></i> Total seluruh mahasiswa
        </p>
      </div>
    </div>
  </div>
          ...
          <table class="table table-striped" id="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-info" href="{{route('transaksi.show', $data->id)}}">
                    Lihat Detail
                  </a>
