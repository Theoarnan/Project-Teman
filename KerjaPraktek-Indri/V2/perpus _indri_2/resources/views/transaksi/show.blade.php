                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="mahasiswa_id" class="col-md-4 control-label">Buku</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="mahasiswa_id" class="col-md-4 control-label">Anggota</label>
                            <div class="col-md-6">
                                <input id="mahasiswa_id" type="text" class="form-control" readonly="" value="{{$data->mahasiswa->nama}}">
