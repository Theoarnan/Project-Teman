    ...
    <div class="nav-link">
      <div class="user-wrapper">
        <div class="profile-image">
          ...
          <img src="{{asset('images/user/logo.png')}}" alt="profile image">
          @else
  ...
  <li class="nav-item {{ setActive(['mahasiswa*', 'buku*', 'user*']) }}">
    ...
    <div class="collapse {{ setShow(['mahasiswa*', 'buku*', 'user*']) }}" id="ui-basic">
      <ul class="nav flex-column sub-menu">
        <li class="nav-item">
          <a class="nav-link {{ setActive(['mahasiswa*']) }}" href="{{route('mahasiswa.index')}}">Data Mahasiswa</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ setActive(['dosen*']) }}" href="{{route('dosen.index')}}">Data Dosen</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ setActive(['kategori*']) }}" href="{{route('kategori.index')}}">Kategori Buku</a>
        </li>
        <li class="nav-item">
