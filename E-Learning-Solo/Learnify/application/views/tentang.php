...
<section class="about_area p_60">
	<div class="container">
		<div class="main_title">
			<h2 style="font-size: 33px !important;">Tentang BioLearn - Web Edukasi</h2>
			<p>BioLearn adalah website
					...
					<div class="card">
						...
						<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
							<div class="card-body">
								...
								menjadi generasi emas yang menghasilkan beragam prestasi untuk dirinya maupun bangsa.
					...
					<div class="card">
						...
						<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
							<div class="card-body">
								...
								dimana saja dan kapan saja dengan BioLearn.
							</div>
						</div>
					</div>
					<div class="card">
		...
		<div class="about_details">
			<p>
				BioLearn adalah website pembelajaran dimana para siswa dapat belajar dimana saja dan kapan saja.
				dan guru dapat mengupload video dirinya sendiri sedang mengajar. sehingga tanpa takut adanya Jam
				kosong atau pun keadaan yang tidak terduga apapun karena BioLearn dapat diakses dimana saja dan
				kapan saja untuk belajar.
			</p>
...
<!-- <section class="team_area p_20">
    <div class="container">
        <div class="main_title">
            <h2>Testimonial Para Siswa BioLearn</h2>
            <p>Berikut kesan dan pesan para siswa yang sudah menggunakan layanan website BioLearn. Pastikan kamu
...
<section class="impress_area p_120">
	<div class="container">
		<div class="impress_inner text-center">
			<h2>JADILAH PENGAJAR DAN MENGAJAR DI BIOLEARN</h2>
			<p>Jika anda adalah seorang guru, anda dapat mendaftar dan masuk untuk mengajar para siswa di BioLearn.
