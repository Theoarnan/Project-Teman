	...
	<div class="container">
		<div class="row">
			<div class="col-lg-2  col-md-6 col-sm-6">
				<div class="single-footer-widget tp_widgets">
					...
					<ul class="list">
						<li><a href="<?= base_url('welcome/tentang') ?>">Tentang BioLeran</a></li>
						<li><a href="<?= base_url('welcome/materi') ?>">Materi BioLeran</a></li>
						<li><a href="<?= base_url('welcome/kontak') ?>">Kontak BioLeran</a></li>
			...
			<div class="col-lg-2  col-md-6 col-sm-6">
				<div class="single-footer-widget tp_widgets">
					...
					<ul class="list">
						<li><a href="https://github.com/Theoarnan">Theoarnan</a></li>
					</ul>
				</div>
			</div>
		...
		<div class="row footer-bottom d-flex justify-content-between align-items-center">
			...
			<div class="col-lg-4 col-md-4 footer-social">
				<a href="https://www.facebook.com/arnan.abdiel.9/"><i class="fa fa-facebook"></i></a>
				<a href="https://twitter.com/theoarnan11"><i class="fa fa-twitter"></i></a>
			</div>
		</div>
	</div>
</footer>
