...
<head>
	...
	<title>BioLearn - Belajar Dimana Saja & Kapan Saja !</title>
	<!-- Bootstrap CSS -->
			...
			<div class="container">
				<div class="float-left">
					<ul class="list header_social">
						<li><a href="https://www.facebook.com/arnan.abdiel.9"><i class="fa fa-facebook"></i></a></li>
						<li><a href="https://twitter.com/theoarnan11"><i class="fa fa-twitter"></i></a></li>
						<li><a href="https://dribbble.com/theoarnan"><i class="fa fa-dribbble"></i></a></li>
					</ul>
				</div>
				<div class="float-right">
					<a class="dn_btn" href="tel:+6287830016267">082216141315</a>
					<a class="dn_btn" href="mailto:learnifyedu@gmail.com">testbiolearn@gmail.com</a>
				</div>
			</div>
		</div>
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/logo.png" width="180" height="60" alt=""></a>
