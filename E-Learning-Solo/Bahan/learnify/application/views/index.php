	...
	<div class="banner_inner d-flex align-items-center">
		...
		<div class="container">
			<div class="banner_content text-center">
				<h3 data-aos="fade-up" data-aos-duration="1600">Belajar Dimana Saja & Kapan Saja <br /> Mudah Dengan BioLearn</h3>
				<p data-aos="fade-up" data-aos-duration="1900">Dengan BioLearn kemudahan kegiatan belajar mengajar dapat terpenuhi. Para guru dan siswa dapat
					belajar meski banyak halangan atau rintangan. Nikmati Pembelajaran terstruktur dan efektif menggunakan BioLearn serta kemudahan belajar dengan menggunakan aplikasi kami. </p>
		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					<h2 data-aos="fade-up" data-aos-duration="2000">BioLearn Dibuat Untuk Meningkatkan Kualitas Pembelajaran Di Indonesia</h2>
...
<section class="courses_area p_40">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1600">Pelajaran Yang Tersedia di BioLearn</h2>
					...
					<div class="grid_item wd44">
						<div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
							...
							<div class="hover_text">
								<a class="cat" href="#">Gratis</a>
								<a href="javaScript:void(0);">
									<h4>Kelas Biologi Intermediete</h4>
								</a>
							</div>
						</div>
					</div>
