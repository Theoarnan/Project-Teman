...
BioLearn adalah Web edukasi yang dilengkapi video, materi dan sistem ujian
yang tersedia secara gratis. BioLearn dibuat ditujukan agar para siswa dan
		...
		<div class="row">
			<div class="col-lg-3  col-md-6 col-sm-6">
				<div class="single-footer-widget tp_widgets">
					...
					<ul class="list">
						<li><a href="<?= base_url('welcome/tentang') ?>">Tentang BioLearn</a></li>
						<li><a href="<?= base_url('welcome/materi') ?>">Materi BioLearn</a></li>
						<li><a href="<?= base_url('welcome/kontak') ?>">Kontak BioLearn</a></li>
					</ul>
				</div>
			</div>
			<div class="col-lg-3  col-md-6 col-sm-6">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="single-footer-widget tp_widgets">
					...
					<ul class="list">
						<li><a href="javaScript:void(0);">Biologi Dasar</a></li>
						<li><a href="javaScript:void(0);">Biologi Menengah</a></li>
						<li><a href="javaScript:void(0);">Biologi Tingkat Lanjut</a></li>
						<li><a href="javaScript:void(0);">Biologi Teori</a></li>
						<li><a href="javaScript:void(0);">Biologi Praktikum</a></li>
					</ul>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<h4 class="footer_title">Tentang BioLearn</h4>
				<p>
					BioLearn adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. BioLearn dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
				</p>
			</div>
		</div>
