<div class="">
	...
	<div class="card card-success">
		...
		<div id="detail" class="card-body">
			<form method="POST" enctype="multipart/form-data" action="<?= base_url('tugas/tambah_tugas') ?>">
					...
					<form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_tugas') ?>">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								...
								<input autocomplete="on" required type="text" list="nama_guru" id="namaguru" name="nama_guru" class="form-control">
						...
						<div class="form-group">
							...
							<input autocomplete="off" required type="text" id="nama_tugas" name="nama_tugas" class="form-control" placeholder="Judul">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input autocomplete="off" required type="text" list="nama_gurus" id="namagurus" name="nama_gurus" class="form-control">
							...
							<datalist id=nama_gurus>
								...
								while ($l = mysqli_fetch_array($qry)) {
									echo "<option value='$l[id]'>$l[nama_mapel]</option>";
								}
								?>
							</datalist>
						</div>
						<div class="form-group">
							...
							<input type="number" class="form-control" required name="durasi" id="durasi" placeholder="Durasi">
						</div>
						<div class="form-group">
							<label for="exampleFormControlTextarea1">Info Tugas</label>
							<textarea class="form-control" required name="info" id="exampleFormControlTextarea1" placeholder="info"></textarea>
						</div>
						<div class="form-group">
