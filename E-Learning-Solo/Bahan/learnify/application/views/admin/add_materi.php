...
<head>
	...
	<title>Tambah Data Materi - BioLearn </title>
	<!-- General CSS Files -->
									...
									<div class="col-md-12 bg-white" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
										<form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
												...
												<div class="form-group col-md-12">
													...
													<datalist id=nama_guru>
														...
														while ($t = mysqli_fetch_array($qry)) {
															echo "<option name='nama_list' value='$t[nip]'>$t[nama_guru]</opttion>";
														}
														?>
													</datalist>
												</div>
											...
											<div class="form-group">
												...
												<input autocomplete="off" required type="text" list="nama_gurus" value="" onkeyup="autofill2()" id="namagurus" name="nama_gurus" class="form-control">
											...
											<div class="form-group">
												...
												<textarea class="summernote" rows="5" id="summernote" name="isi">Place <em>some</em> <u>text</u> <strong>here</strong></textarea>
											</div>
