<div class="">
	...
	<div class="card card-success">
		...
		<div id="detail" class="card-body">
			<form method="POST" enctype="multipart/form-data" action="<?= base_url('kelas/updated_kelas') ?>">
				<div class="col-md-12 bg-white" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
					<form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_tugas') ?>">
						...
						<div class="form-group">
							...
							<input autocomplete="off" required type="text" value="<?= $data->kelas ?>" id="nama_kelas" name="nama_kelas" class="form-control" placeholder="Nama Kelas">
						</div>
