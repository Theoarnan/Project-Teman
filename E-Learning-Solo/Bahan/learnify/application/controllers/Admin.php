...
class Admin extends CI_Controller
{
	...
	public function about_developer()
	{
		$data['user'] = $this->db->get_where('admin', ['email' =>
		$this->session->userdata('email')])->row_array();
		$data['page'] = 'admin/about_developer';
		$this->load->view('admin/index', $data);
	}
	...
	public function about_learnify()
	{
		$data['user'] = $this->db->get_where('admin', ['email' =>
		$this->session->userdata('email')])->row_array();
		$data['page'] = 'admin/about_learnify';
		$this->load->view('admin/index', $data);
	}
	...
	public function materi_edit()
	{
		...
		$id = $this->input->post('id');
		$nama = htmlspecialchars($this->input->post('nama_gurus', true));
		if ($nama) {
			$data = array(
				'nama_guru' => htmlspecialchars($this->input->post('nama_guru', true)),
				// 'nama_mapel' => htmlspecialchars($this->input->post('nama_gurus', true)),
				'deskripsi' => $this->input->post('deskripsi', true),
				'kelas' => htmlspecialchars($this->input->post('kelas', true)),
				'materi_deks' => htmlspecialchars($this->input->post('isi', true)),
			);
		} else {
			$data = array(
				'nama_guru' => htmlspecialchars($this->input->post('nama_guru', true)),
	...
	public function add_guru()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$data = [
				...
				'nama_mapel' => $this->input->post('nama_gurus', true),
			];
